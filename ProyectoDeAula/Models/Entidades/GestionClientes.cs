...
namespace ProyectoDeAula.Models.Entidades
{
    public class GestionClientes
    {
        ...
        public static string MostrarClientes(List<Cliente> clientes)
        {
            ...
            {
                texto.AppendLine($" Nombre: {cliente.nombre}, Apellido: {cliente.apellido}, Cédula: {cliente.cedula}, Estrato: {cliente.estrato}, Meta de ahorro: {cliente.meta_ahorro}, Consumo de energía: {cliente.consumo_energia}, Consumo de agua: {cliente.consumo_agua}");
            }
...

        {
            ...
            if (clienteActualizar != null)
            {
                ...
                clienteActualizar.ActualizarCliente(nuevonombre, nuevoapellido, nuevaCedula, nuevoEstrato, nuevaMetaAhorro, nuevoConsumoEnergia, nuevoConsumoAgua);
